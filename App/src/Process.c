...
const D_tab D_Tab[23] ={  // pulse waveform output driver table, based on the 72MHz frequency
//    STR      PSC     ARR       DUTY% 
...
const A_tab A_Tab[15] ={ // analog waveform output driver table synthesis, based on the 72MHz frequency, per 36
...
uc16 TRG_DATA[72] =  // triangle wave data
...
uc16 SAW_DATA[72] =  // Sawtooth wave data                                                                                             //         
  {0,
...
uc16 DIGI_DATA[72] =  // Square wave data                                                                                             //         
