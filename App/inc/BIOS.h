...
#define FIFO_CLR          6     // FIFO pointer reset the Value       Value = 1/0: W_PTR/R_PTR
...
#define T_BASE_ARR        8     // frequency value			          Value = 0~65535
...
#define A_POSITION       32+5  // the 0:00 position of CH_A Value     Value = 0~200
#define B_POSITION       32+6  // the zero position of CH_B Value     Value = 0~200
...
{
  u16 LCD_X;    // screen level display points
  ...
  u16 Yv_Max;   // vertical displacement of the maximum
  u16 Xt_Max;   // horizontal displacement of the maximum
...
typedef struct  // level of channel properties
{
  char  STR[8];   // stall identification string
